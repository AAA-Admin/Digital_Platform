      ...
      <div className="section-max">
        ...
        <div className="founders-grid">
          ...
          <div className="founder-card reveal delay-2">
            <div className="founder-avatar" style={{ background: 'linear-gradient(135deg, var(--bg3), #001a1a)' }}>NA</div>
            <div className="founder-name">Najib Bin Arif</div>
            <div className="founder-role">Director, Administrations</div>
